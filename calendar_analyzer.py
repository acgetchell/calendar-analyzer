...
def generate_summary(meetings, stats):
    ...
    summary = [
        ...
        f"- All times are automatically adjusted for DST transitions",
        f"- Meetings during DST periods are shown in PDT",
        f"- Meetings during standard time are shown in PST",
        f"\nMeeting Statistics:",
...
def main():
    ...
    parser.add_argument('--days', type=int, default=365, help='Number of days to look back from end date (default: 365)')
